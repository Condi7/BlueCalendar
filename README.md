...
# Assegnare ad un dipendente dei giorni di ferie/permesso
Per fare in modo che un dipendente possa avere la possibilità di richiedere ferie o permessi, prima dovremo assegnarli dei giorni di ferie/permesso.
<br/>
**ATTENZIONE!**
