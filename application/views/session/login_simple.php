...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="span12">
        <img width="100" src="<?php echo base_url(); ?>assets/images/logo_bluecube.png">
      </div>
    </div>
    <div class="row">
      <div class="span12">
        <form id="loginForm" method="POST" action="<?php echo base_url(); ?>api/authorization/login">
          ...
          <input type="text" class="input-medium" name="login" id="login" value="<?php echo set_value('login'); ?>"
            required />
