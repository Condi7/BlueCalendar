...
echo form_open('extra/create', $attributes) ?>
    ...
    <select name="status">
        <option value="2" <?php if (set_value('status', '2') != '1') echo 'selected'; ?>><?php echo lang('Requested');?></option>
        <option value="1" <?php if (set_value('status') == '1') echo 'selected'; ?>><?php echo lang('Planned');?></option>
    </select>
</form>
