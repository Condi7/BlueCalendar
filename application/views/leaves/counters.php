...
<div class="row-fluid">
    <div class="span12">
        ...
        <p><?php echo "Saldo Ferie/Permessi : ultimo cedolino";?></p> <!--AD_MOD new da inserire-->

        <p><?php echo lang('leaves_summary_date_field');?>&nbsp; 
            <input type="text" id="refdate" readonly /> <!--AD_MOD readonly-->
        </p>
        ...
        <table class="table table-bordered table-hover">
            ...
            foreach ($summary as $key => $value) {
                ...
                if (($value[2] == '') || ($value[2] == 'x')) {
                    ...
                    $displayedBalance = $estimated;
                    if (!empty($value[6]) && !empty($value[5])) {
                ...
                <td><?php echo $key; ?></td>
                <td>
                    <?php echo formatLeaveDurationHours($displayedBalance); ?>
                </td>
